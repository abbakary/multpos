# Generated by Django 4.2.11 on 2025-09-25 07:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('whatsapp', models.CharField(blank=True, help_text='WhatsApp number (if different from phone)', max_length=20, null=True)),
                ...
                ('customer_type', models.CharField(blank=True, choices=[('government', 'Government'), ('ngo', 'NGO'), ('company', 'Private Company'), ('personal', 'Personal')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('service', 'Service'), ('sales', 'Sales'), ('inquiry', 'Inquiries')], max_length=16)),
                ('status', models.CharField(choices=[('created', 'Start'), ('in_progress', 'In Progress'), ('overdue', 'Overdue'), ('completed', 'Completed'), ('cancelled', 'Cancelled')], default='created', max_length=16)),
                ...
                ('signature_file', models.ImageField(blank=True, null=True, upload_to='order_signatures/')),
                ('completion_attachment', models.FileField(blank=True, null=True, upload_to='order_attachments/')),
                ...
                ('signed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders_signed', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddConstraint(
            model_name='customer',
            constraint=models.UniqueConstraint(fields=('full_name', 'phone', 'organization_name', 'tax_number'), name='uniq_customer_identity'),
        ),
        migrations.AddIndex(
            model_name='brand',
